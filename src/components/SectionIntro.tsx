...
const pillarIcons: Record<Pillar, JSX.Element> = {
  fragmentation: (
...
export default function SectionIntro({
  ...
  return (
    <div className="animate-fadeIn flex flex-col items-center text-center">
      <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-2xl bg-navy-50 text-navy-700">
        {pillarIcons[pillar]}
      </div>
      <div className="mb-2 text-sm font-semibold uppercase tracking-wider text-navy-500">
        Section {sectionNumber} of 3
      </div>
      <h2 className="mb-3 text-3xl font-bold text-navy-900">{title}</h2>
